    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-9">
            ...
            <div>
                <label for="request_type"><?php echo($row['request_type'])?></label>
              </div>
              <div>
                <label for="name"><?php echo($row['employee_name'])?></label>
              </div>
              <div>
                <label for="designation"><?php echo($row['designation'])?></label>
              </div>
              <div>
